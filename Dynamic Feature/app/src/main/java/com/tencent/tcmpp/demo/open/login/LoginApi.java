...
public class LoginApi {
    ...
    public void login(String appId, String userId, String passwd, ResultCallback<UserInfo> callback) {
    ...
    public void getAuthCode(String appId, String miniAppId, String token, ResultCallback<String> callback) {
        JSONObject body = new JSONObject();
        try {
            body.put("appId", appId);
    ...
    private void request(String apiUrl, JSONObject body, ResultCallback<JSONObject> callback) {
